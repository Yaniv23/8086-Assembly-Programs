...
; variables to save the original INT 0 handler
old_int0_off dw ?
old_int0_seg dw ?
...
start:
    ...
    ; Save original handler offset and segment
    ...
    ; Prompt user for a number using print_string
    lea dx,msg_num
    call print_string
    ...
    ; Try to divide 1 by user input (triggers handler if input is 0)
    mov al,1
    div bl
